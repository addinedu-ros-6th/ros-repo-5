...
{
  new (message_memory) taskmanager_msgs::msg::RobotStatus(_init);
}

void RobotStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<taskmanager_msgs::msg::RobotStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotStatus_message_member_array[4] = {
  {
    ...
    offsetof(taskmanager_msgs::msg::RobotStatus, robot_status),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(taskmanager_msgs::msg::RobotStatus, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(taskmanager_msgs::msg::RobotStatus, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(taskmanager_msgs::msg::RobotStatus, battery_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(taskmanager_msgs::msg::RobotStatus),
...
get_message_type_support_handle<taskmanager_msgs::msg::RobotStatus>()
{
  return &::taskmanager_msgs::msg::rosidl_typesupport_introspection_cpp::RobotStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, taskmanager_msgs, msg, RobotStatus)() {
  return &::taskmanager_msgs::msg::rosidl_typesupport_introspection_cpp::RobotStatus_message_type_support_handle;
}

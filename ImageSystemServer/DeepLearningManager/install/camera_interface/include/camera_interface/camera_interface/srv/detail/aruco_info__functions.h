...
#ifndef CAMERA_INTERFACE__SRV__DETAIL__ARUCO_INFO__FUNCTIONS_H_
#define CAMERA_INTERFACE__SRV__DETAIL__ARUCO_INFO__FUNCTIONS_H_
...
/// Initialize srv/ArucoInfo message.
/**
...
/// Finalize srv/ArucoInfo message.
/**
...
/// Create srv/ArucoInfo message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * camera_interface__srv__ArucoInfo_Request__init().
...
/// Destroy srv/ArucoInfo message.
/**
 * It calls
 * camera_interface__srv__ArucoInfo_Request__fini()
...
/// Check for srv/ArucoInfo message equality.
/**
...
/// Initialize array of srv/ArucoInfo messages.
/**
...
/// Finalize array of srv/ArucoInfo messages.
/**
 * It calls
 * camera_interface__srv__ArucoInfo_Request__fini()
...
/// Create array of srv/ArucoInfo messages.
/**
 * It allocates the memory for the array and calls
 * camera_interface__srv__ArucoInfo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ArucoInfo messages.
/**
 * It calls
 * camera_interface__srv__ArucoInfo_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ArucoInfo message array equality.
/**
...
/// Copy an array of srv/ArucoInfo messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * camera_interface__srv__ArucoInfo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_interface
...
/**
 * It calls
 * camera_interface__srv__ArucoInfo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_interface
...
/**
 * It allocates the memory for the array and calls
 * camera_interface__srv__ArucoInfo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_interface
...
/**
 * It calls
 * camera_interface__srv__ArucoInfo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAMERA_INTERFACE__SRV__DETAIL__ARUCO_INFO__FUNCTIONS_H_
